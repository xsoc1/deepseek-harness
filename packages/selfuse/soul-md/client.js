...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var tagId = "@dsh-selfuse/soul-md/main.css";
    if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
      var tag = document.createElement("style");
      tag.dataset.plugin = "@dsh-selfuse/soul-md";
    ...
    function apply(ctx) {
      ...
      ctx.effect(function () { return ctx.locale.register(NS, { zh: zh, en: en }); }, "@dsh-selfuse/soul-md: dictionaries");
