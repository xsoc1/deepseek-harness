/**
 * Package-owned invariant companion for `@dsh-selfuse/better-sidebar`.
 * @module @dsh-selfuse/better-sidebar/invariant
 */

/* jscpd:ignore-start */
import type { Context } from './context-types.ts'

const PACKAGE_NAME = '@dsh-selfuse/better-sidebar'

/** Cordis companion plugin name. */
export const name = '@dsh-selfuse/better-sidebar-invariant'
