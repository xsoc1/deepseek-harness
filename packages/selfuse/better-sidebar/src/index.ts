/**
 * @dsh-selfuse/better-sidebar host half: the /sidebar JSON API (explorer listing, file
...
// `import type {} from '@dsh-selfuse/better-sidebar'` and gain `ctx.betterSidebar`.
...
export const name = '@dsh-selfuse/better-sidebar'
...
export function apply(ctx: Context, config?: SidebarConfig): void {
  ...
  }), '@dsh-selfuse/better-sidebar: /sidebar/api routes')
  ...
  ctx.effect(() => registerBundleRoute(ctx, fence), '@dsh-selfuse/better-sidebar: /sidebar/bundle chunk route')
  ...
  }), '@dsh-selfuse/better-sidebar: /sidebar/file media route')
  ...
  }), '@dsh-selfuse/better-sidebar: /sidebar/html preview route')
  ...
  }), '@dsh-selfuse/better-sidebar: terminal WebSocket')
  ...
  }), '@dsh-selfuse/better-sidebar: agent-terminals push WebSocket')
  ...
  ctx.effect(() => () => {
    ...
    wss.close()
    agentListWss.close()
  }, '@dsh-selfuse/better-sidebar: teardown')
}
