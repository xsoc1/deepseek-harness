...
> 日期:2026-08-12
> 状态:已实现
> 范围:`@dsh-selfuse/better-sidebar` 插件,客户端 bundle 拆分
...
- chunk 注册 id 恒定 `@dsh-selfuse/better-sidebar/<name>`,两渠道共用(每页只活一个渠道——双渠道并存本就双挂载,属既有破损组合);
