...
```sh
dsh plugin --profile web add @dsh-selfuse/web-ui-task-board@latest
```
...
```sh
pnpm --filter @dsh-selfuse/web-ui-task-board typecheck
pnpm --filter @dsh-selfuse/web-ui-task-board test
pnpm --filter @dsh-selfuse/web-ui-task-board build
```
