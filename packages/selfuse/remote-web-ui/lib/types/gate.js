...
export function isLoopbackClient(request) {
 ...
 */
export function makeGateListener(service, requirePairingForLan = true, enabled = true) {
 ...
 */
export function isPairedDeviceRequest(service, request) {
