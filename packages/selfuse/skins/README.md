...
Retired compatibility carrier (kept for one release cycle): every skin is built into `@dsh-selfuse/skin-center`. This package pulls in the skin center and ships asset-free no-op leaf packages so stale v1 profile junctions remain resolvable until the legacy bridge removes them.
