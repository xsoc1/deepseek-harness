/**
 * `@dsh-selfuse/backup` 浏览器半边：挂载 `backupPanel` Remote 贡献，并在 Settings
...
export async function apply(ctx) {
  ctx.effect(() => ctx.locale.register(NS, { zh, en }), '@dsh-selfuse/backup: dictionaries');
  ctx.effect(() => installPanelStyles(), '@dsh-selfuse/backup: stylesheet');
